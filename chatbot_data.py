...
def create_chains(llm, db):
    ...
    answer_prompt = PromptTemplate.from_template("""
        ...
        Use conversation capabilities with the user. When it's queries for database provide answer in the aforementioned structured format.
        """
    )
